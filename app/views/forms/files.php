...
<form role="form" method="post" enctype="multipart/form-data">
  <div class="form-group">
    <label>Title </label>
    <input type="text" class="form-control" required="" name="nama" placeholder="Ex: Tutorial memasak masakan padang"/>
  </div>
  
  <div class="form-group">
    <label>Deskripsi</label>
    <textarea id="edit" name="deskripsi" required="" class="form-control" rows="50"></textarea>
  </div>
